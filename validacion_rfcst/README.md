...
## Fuentes de las cifras globales

Además del presupuesto (abajo), los **reales 2025 globales** salen del archivo
`BDFCST26*.xlsx` (hoja `BD`, columnas `Primas USD` / `Siniestros USD` /
