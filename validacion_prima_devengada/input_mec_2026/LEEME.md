...
La cohorte de la BD real no cambia: ahí sí hay `Fecha Inicio de Vigencia` por registro y el diseño original del script la usa deliberadamente para cohortar por vigencia mensual. Si prefieres que también la BD cohorte por mes contable, es una línea en `fuente_bd()`.
