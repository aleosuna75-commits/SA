...
zAño= 2026
zMes = 12
xFolder = fr"C:\Users\{usuario}\OneDrive - GPV\Documentos\Planeación Financiera\Forecasts\2026\Programas\Inputs"
...
ParamSONR = pd.read_csv(f"{xFolder}\\ParamSONR2026.csv")
ParamSONR_inc = pd.read_csv(f"{xFolder}\\ParamSONR2026.csv")
...
#%% ESCENARIO 3
    ...
    xFolder = fr"C:\Users\{usuario}\OneDrive - GPV\Documentos\Planeación Financiera\Forecasts\2026\Programas\Outputs"
