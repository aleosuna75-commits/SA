...
def _a_fecha(valor):
    ...
    (días desde 1899-12-30, como aHCF_FecInicio). Regresa None si no hay
    fecha válida. Esto evita comparaciones entre tipos mezclados y errores
    por hora del día.
    """
    if pd.isna(valor):
        return None
...
xFolder = r"C:\Users\asunad\OneDrive - GPV\Planeación Financiera RPAT - Reporting y Consultas\Consulta Identificación RetroEsp"
fileName_Retro = f"{xFolder}\\Ident_RetroEsp_Facv2.xlsm"
...
Ident_RetroEsp.save(f"{xFolder}\\Ident_RetroEsp_Facv2.xlsm")
